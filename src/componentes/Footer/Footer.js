    ...
    return (
        <div className='footer'>
            ...
            <div className='category'>
                <Link to="/" className="navbar__link rounded-lg px-3 py-2 text-slate-700 font-medium hover:bg-slate-600 hover:text-slate-900"><h6>Conocé nuestros productos</h6></Link>
